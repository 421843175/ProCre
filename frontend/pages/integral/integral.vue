	...
	<view class="content">
		<view class="t-wrap">
			<view class="t-jf">
				<view class="t-jf-points">
					<view class="t-jf-title">我的创造粒</view>
		...
		<view class="t-sign-con">
			<view class="wrap">
				<view class="t-sign-top">
					<view class="lx">已连续签到<text>5</text>天</view>
					<view class="gz" hover-class="t-hc" @click="openRule">签到规则<image src="/static/icon-ask.png"></image>
					</view>
				</view>
				<view class="t-sign-body">
					<view :class="['t-sign-item',{'signed':isSigned}]">
						<view class="t-img-con">
							<view class="t-img">
								<image :src="'/static/icon-'+(isSigned?'check':'uncheck')+'.png'"></image>
							</view>
						</view>
						<text>+100</text>
					</view>
					<view class="t-sign-item">
						<view class="t-img-con">
							<view class="t-img">
								<image src="/static/icon-uncheck.png"></image>
							</view>
						</view>
						<text>+100</text>
					</view>
		...
		<view class="t-task">
			...
			<view class="t-task-item">
				<view class="left">
					<view class="taskname">
						购买课程<text>+100积分</text>
					</view>
					<view class="taskdesc">
						购买任意课程即可完成任务
					</view>
				</view>
				<view class="right" hover-class="t-hc">去购买</view>
			</view>
			<view class="t-task-item">
				<view class="left">
					<view class="taskname">
						分享课程<text>+200积分</text>
					</view>
					<view class="taskdesc">
						分享任意课程即可完成任务
					</view>
				</view>
				<view class="right" hover-class="t-hc">去分享</view>
			</view>
			<view class="t-task-item">
				<view class="left">
					<view class="taskname">
				...
				<view class="right" hover-class="t-hc">去收藏</view>
			</view>
			<view class="t-task-item">
				<view class="left">
					<view class="taskname">
						完善信息<text>+100积分</text>
					</view>
					<view class="taskdesc">
						完善个人信息获得积分
					</view>
				</view>
				<view class="right" hover-class="t-hc">去完善</view>
			</view>
			<view class="t-task-item">
				<view class="left">
					<view class="taskname">
		...
		<kevy-mask :show="showSignBox" @click="closeSign" :maskClose="true" :z-index="10">
			...
			<view class="t-o-wrap">
				<image class="t-sign-bg" src="/static/sign.png"></image>
				<view class="t-g-jf">+100积分</view>
				<view class="t-g-desc">已连续签到5天，继续签到有惊喜哦~</view>
		...
		<kevy-mask :show="showRuleBox" @click="closeRule" :maskClose="true" :z-index="10">
			<view class="t-o-wrap">
				...
				<image @click="closeRule" class="t-close" src="../../static/close.png"></image>
			</view>
		</kevy-mask>
	</view>
</template>
