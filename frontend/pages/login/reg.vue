<template>
  <view class="content">
    <view class="header" style="margin-top:80rpx;">
      <image src="../../static/loginimg/projectcreatethis.jpg"></image>
    </view>

    <view class="list">
      <view class="list-call" style="margin-top:60rpx;">
        <image class="img" src="/static/loginimg/1.png"></image>
        <input class="sl-input" v-model="mail" type="text"  placeholder="邮箱" />
      </view>
      ...
      <view class="list-call">
        <image class="img" src="/static/loginimg/4.png"></image>
        <input class="sl-input" v-model="invitation" type="text" maxlength="12" placeholder="申请码" />
      </view>
    ...
    <view class="agreement">
      <image @tap="agreementSuccess" :src="agreement==true?'/static/loginimg/ty1.png':'/static/loginimg/ty0.png'"></image>
      <text @tap="agreementSuccess"> 同意</text>
      <navigator url="agreement?id=1" open-type="navigate">《木星开发用户协议》</navigator>
    </view>
  </view>
</template>
